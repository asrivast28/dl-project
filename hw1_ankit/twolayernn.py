...
class TwoLayerNN(nn.Module):
    def __init__(self, im_size, hidden_dim, n_classes):
        ...
        C, H, W = im_size;
        D = C * H * W;
        self.linear1 = torch.nn.Linear(D, hidden_dim);
        self.linear2 = torch.nn.Linear(hidden_dim, n_classes);
        #############################################################################
        #                             END OF YOUR CODE                              #
        #############################################################################
    ...
    def forward(self, images):
        ...
        #############################################################################
        N = images.shape[0];
        h_relu = self.linear1(images.reshape(N,-1)).clamp(min=0);
        Z = self.linear2(h_relu);
        scores = Z;
        #############################################################################
        #                             END OF YOUR CODE                              #
        #############################################################################
